...
void lcd_clear_light(void){
	lcd_DrawCircle(70, 100, BLACK, BLACK, 1);
	lcd_DrawCircle(110, 100, BLACK, BLACK, 1);
	lcd_DrawCircle(150, 100, BLACK, BLACK, 1);
	lcd_DrawCircle(70, 130, BLACK, BLACK, 1);
	lcd_DrawCircle(110, 130, BLACK, BLACK, 1);
	lcd_DrawCircle(150, 130, BLACK, BLACK, 1);
}
